...
const PAYMENTS_API_URLwithItemcode = 'https://fixmymaclk-33hy.onrender.com/api/payments/with-itemcodes';
...
const ProductList = ({ darkMode }) => {
  ...
  const loadSupplierQuantities = async () => {
    ...
    try {
      const res = await fetch('https://fixmymaclk-33hy.onrender.com/api/suppliers');
  ...
  const handleUploadExcel = async () => {
    ...
    try {
      ...
      const response = await fetch('https://fixmymaclk-33hy.onrender.com/api/product-uploads/bulk-upload',
      {
        method: 'POST',
  ...
  const fetchUploadedRecords = async (page = 1) => {
    ...
    setUploadedError('');
    try {
      const res = await fetch(`https://fixmymaclk-33hy.onrender.com/api/product-uploads?page=${page}&limit=20`);
  ...
  const handleExportAllUploaded = async () => {
    try {
      const res = await fetch('https://fixmymaclk-33hy.onrender.com/api/product-uploads/export-all');
