...
const API_URL = "https://fixmymaclk-yzgm.onrender.com/api/dashboard";
const PRODUCTS_REPAIR_API_URL = 'https://fixmymaclk-yzgm.onrender.com/api/productsRepair';
const EXTRA_INCOME_API_URL = 'https://fixmymaclk-yzgm.onrender.com/api/extra-income';
const SALARIES_API_URL = 'https://fixmymaclk-yzgm.onrender.com/api/salaries';
const MAINTENANCE_API_URL = 'https://fixmymaclk-yzgm.onrender.com/api/maintenance';
const PAYMENTS_API_URL = 'https://fixmymaclk-yzgm.onrender.com/api/payments/forsummery';
const PRODUCTS_API_URL = 'https://fixmymaclk-yzgm.onrender.com/api/products';
const SUPPLIERS_API_URL = 'https://fixmymaclk-yzgm.onrender.com/api/suppliers';
