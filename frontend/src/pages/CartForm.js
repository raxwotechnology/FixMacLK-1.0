...
const CartForm = ({ supplier, item, closeModal, darkMode, refreshProducts }) => {
  ...
  const fetchNames = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://fixmaclk-1-0.onrender.com/api/product-uploads`, {
      });

      // const response = await axios.get('https://fixmaclk-1-0.onrender.com/api/products', {
      //   headers: {
