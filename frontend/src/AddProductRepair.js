  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        ...
        const response = await fetch("https://fixmaclk-1-0.onrender.com/api/productsRepair");
        if (response.ok) {
    ...
    const fetchDeviceIssues = async () => {
      try {
        ...
        const response = await fetch("https://fixmaclk-1-0.onrender.com/api/deviceIssues");
        if (response.ok) {
          const data = await response.json();
    ...
    const fetchDeviceTypes = async () => {
      try {
        ...
        const response = await fetch("https://fixmaclk-1-0.onrender.com/api/deviceTypes");
        if (response.ok) {
          const data = await response.json();
          setDeviceTypes(data);
